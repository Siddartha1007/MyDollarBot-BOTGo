...
def test_run(mock_telebot, mocker):
    ...
    edit.helper.getSpendUserHistory(message.chat.id).return_value = MOCK_USER_DATA[str(MOCK_CHAT_ID)]['data']
    edit.run(message, mc)
...
def test_edit_date(mock_telebot, mocker):
    ...
    edit.helper.getSpendUserHistory(MOCK_CHAT_ID).return_value = MOCK_USER_DATA[str(MOCK_CHAT_ID)]['data']
    message = create_message("hello from testing!")
